...
@post_router.post("/api/user/me/post/",tags=['post'],status_code=201,response_model=dict)
...
@post_router.delete('/api/user/post/{id}',tags=['post'])
...
@post_router.get("/api/user/post/{status}",tags=['post'])
...
@post_router.put('/api/user/post/{id}',tags=['post'])
